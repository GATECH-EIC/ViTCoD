...
def plot_func(arr, save_dir):
    ...
    # print (vals[0][0])
    fig = plt.figure(figsize=(2*num_layers, 2*num_heads))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--attn', default='./attn/LeViT_256/attention_score_dpt1.npy', type=str)
    parser.add_argument('--save_dir', default='./masks/LeViT_256/')
