...
def get_args_parser():
    ...
    # parser.add_argument('--subsample_mask0', default='', type=str)
    # parser.add_argument('--mask1', default='', type=str)
    # parser.add_argument('--subsample_mask1', default='', type=str)
    # parser.add_argument('--mask2', default='', type=str)
    return parser
...
def main(args):
    ...
    if args.mask:
        mask_map["depth0"] = os.path.join(args.mask, 'mask_dpt0.npy')
        mask_map["subsample_mask0"] = os.path.join(args.mask, 'mask_subsample0.npy')
        mask_map["depth1"] = os.path.join(args.mask, 'mask_dpt1.npy')
        mask_map["subsample_mask1"] = os.path.join(args.mask, 'mask_subsample1.npy')
        mask_map["depth2"] = os.path.join(args.mask, 'mask_dpt2.npy')
    model = create_model(
        args.model,
    ...
    if args.resume:
        ...
        # strict=False # saved ckpt was after eval
